...
import com.learn.mqtt.comparison.versionone.scenario2.hivemqttclient.publisher.TestMain_Hivemqmqttclient_Publisher;
import com.learn.mqtt.comparison.versionone.scenario2.hivemqttclient.subscriber.TestMain_Hivemqmqttclient_Subscriber;
import com.learn.mqtt.comparison.versionone.scenario2.pahomqtt.publisher.TestMain_Pahomqtt_Publisher;
import com.learn.mqtt.comparison.versionone.scenario2.pahomqtt.subscriber.TestMain_Pahomqtt_Subscriber;
...
class test1a_sec {
	...
	private static final Logger LOGGER = LogManager.getLogger(test1a_sec.class);
