...
public class TestMain_Hivemqmqttclient_Publisher {
	...
	public static void main(String[] args) {
        ...
        Mqtt5AsyncClient client1 = Mqtt5Client.builder().serverAddress(LOCALHOST_EPHEMERAL1).identifier("JavaSample_sender").simpleAuth(simpleAuth).buildAsync();	// create publisher
