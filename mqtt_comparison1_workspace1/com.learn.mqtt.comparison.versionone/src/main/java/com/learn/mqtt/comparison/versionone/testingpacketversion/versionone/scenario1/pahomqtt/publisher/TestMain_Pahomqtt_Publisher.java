package com.learn.mqtt.comparison.versionone.testingpacketversion.versionone.scenario1.pahomqtt.publisher;
...
public class TestMain_Pahomqtt_Publisher {
	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	MqttClient client1 = new MqttClient("tcp://192.168.50.178:1883", "JavaSample_sender", new MemoryPersistence());
